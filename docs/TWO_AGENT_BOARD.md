...
| Parser reliability/data confidence | Hermes | Antigravity | parser tests, fixtures, import warnings, docs/PARSER_HEALTH.md | Pricing/funnel/shareable artifacts |
| Validation interview plan/results | Hermes | Antigravity | docs/USER_VALIDATION_PLAN.md and summaries from user-provided interviews | Inventing interview outcomes |
...
3. Antigravity updates `docs/AGENT_HANDOFF.md` with:
   - files touched
...
```text
Read AGENTS.md, docs/AI_COLLABORATION.md, docs/SPRINT_DECISION_GATE.md, docs/PARTNERSHIP_STATUS.md, and docs/TWO_AGENT_BOARD.md first.
...
Before stopping:
- Update docs/AGENT_HANDOFF.md with exact files touched, checks run, risks, and ask Hermes to review for remaining Reg Life/GamePlan/payment/public-distribution wording.
...
Read AGENTS.md, docs/TWO_AGENT_BOARD.md, docs/SPRINT_DECISION_GATE.md, docs/PARTNERSHIP_STATUS.md, docs/AGENT_HANDOFF.md, and the changed files.
...
```text
Read docs/TWO_AGENT_BOARD.md and review Hermes's docs/plans only.
...
Update docs/AGENT_HANDOFF.md with your review verdict.
```
