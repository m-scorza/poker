...
export const TILT_BIG_LOSS_BB = 20;
export const TILT_HALF_STACK_FRACTION = 0.5;
export const TILT_MIN_TRIGGERS = 3;
export const TILT_MIN_WINDOW_DECISIONS = 25;
export const TILT_MIN_BASELINE_DECISIONS = 50;
export const TILT_COMPLIANCE_DROP_PP = 10;
export const TILT_VPIP_RISE_PP = 12;
export const TILT_RAISE_SHARE_RISE_PP = 12;
export const TILT_COMPLIANCE_MIN_WINDOW_SAMPLE = 15;
export const TILT_FREQUENCY_MIN_WINDOW_SAMPLE = 20;
