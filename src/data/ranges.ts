...
export const BB_DEFENSE_COVERAGE_NOTE = 'BB suited-fold checks cover normal 2-3x opens only, not all-ins or 5x+ raises, and not all-ins or large raises. ICM pressure can make suited folds acceptable in Advanced profile. Rule-based coverage only, not solver-backed; it is not a full solver-backed BB strategy.';
